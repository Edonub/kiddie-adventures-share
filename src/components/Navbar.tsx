...
const Navbar = () => {
  ...
  return (
    <nav className="w-full py-4 px-4 sm:px-8 flex justify-between items-center bg-white border-b border-gray-200">
      ...
      {isMobile && (
        <div className="md:hidden flex items-center gap-2 order-first">
          {/* User Avatar - Now on the far left for mobile */}
          {user ? (
            <DropdownMenu>
          ...
          {/* Mobile menu toggle - Moved to the left of the user icon */}
          <Sheet>
      ...
      <div className={`flex items-center gap-2 ${isMobile ? "mx-auto" : ""}`}>
